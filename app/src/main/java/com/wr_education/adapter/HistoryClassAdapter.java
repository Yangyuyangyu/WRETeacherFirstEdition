...
public class HistoryClassAdapter extends RecyclerView.Adapter<HistoryClassAdapter.ViewHolder>{
    ...
    public HistoryClassAdapter(ArrayList<HistoryClassBean.DataBean> list,Context context) {
        this.list = list;
        this.context=context;
    }
    @Override
    public HistoryClassAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
