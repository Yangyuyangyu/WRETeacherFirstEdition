 ...
 */
public class ClassDetailsTwoAdapter extends BaseAdapter{
    private Context context;
    private ArrayList<ClassDetailsBean.DataBean.CommentBean> list;
    public ClassDetailsTwoAdapter(Context context,ArrayList<ClassDetailsBean.DataBean.CommentBean> list){
