...
import com.wr_education.activity.AlbumActivity;
import com.wr_education.activity.ShowAllPhoto;
import com.wr_education.app.MyApplication;
import com.wr_education.bean.ImageItem;
import com.wr_education.util.BitmapCache;
...
public class FolderAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		MyApplication.getInstance().displayfile(path, holder.imageView, R.mipmap.plugin_camera_no_pictures);
		// 为封面添加监听
